...
export default function Sedans() {
    return (
        <div className="bg-orange p-12 max-lg:rounded-t-lg lg:rounded-l-lg">
          ...
          <h2 className="font-shoulders mb-7 uppercase text-4-xl font-bold text-offwhitebg ">Sedans</h2>
          ...
          <a href="https://www.webmotors.com.br/sedans" target="_blank" className="font-lexend bg-offwhitebg block px-10 py-3 w-fit rounded-3xl text-orange border-2 border-offwhitebg hover:bg-orange hover:text-offwhitebg">Ver mais</a>
        </div>
    )
}